...
import type { Contribuyente } from './ContribuyentesList.';

interface EditContribuyenteModalProps {
  contribuyente: Contribuyente;
  onClose: () => void;
  onSuccess: () => void;
}

export function EditContribuyenteModal({ contribuyente, onClose, onSuccess }: EditContribuyenteModalProps) {
