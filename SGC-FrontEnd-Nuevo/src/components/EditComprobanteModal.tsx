...
interface EditComprobanteModalProps {
  comprobante: Comprobante;
  onClose: () => void;
  onSuccess: () => void;
}

export function EditComprobanteModal({ comprobante, onClose, onSuccess }: EditComprobanteModalProps) {
    ...
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center p-4 z-50">
      <div className="bg-gray-900 border border-emerald-900/30 rounded-lg shadow-2xl w-full max-w-2xl">
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-800">
          <h3 className="text-white">Editar Comprobante Fiscal</h3>
          <button
            onClick={onClose}
